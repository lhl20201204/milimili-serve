...
class CommentService extends Service {
  ...
  async getReply({ replyUserId, auditing }) {
    return auditing ? await this.app.mysql.select('comment', { where: { replyUserId, auditing } }) : await this.app.mysql.select('comment', { where: { replyUserId } });
  }
